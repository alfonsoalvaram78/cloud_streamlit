...
#update_crypto_values_history()
#update_crypto_values_day()
#print( get_data_table('cat_criptomonedas', campos = ['ticker'], condiciones = ['BTC-USD'] ) )
#print( get_data_daily('BTC-USD') )

#print( get_data('BTC-USD', start_date = '2022-01-02', end_date = '') )
#cat_criptomonedas = pd.read_csv('C:/cloud_streamlit/csv/cat_critomonedas.csv')
#cargar_datos('cat_criptomonedas', cat_criptomonedas)

#borrar('cat_criptomonedas', campo_condicional=['nombre'], condicion = ['BNB'])
#borrar('cat_criptomonedas')
#borrar('criptomonedas_hystory')
#borrar('criptomonedas_day')
#eliminar_tabla('criptomonedas_hystory')
#eliminar_tabla('criptomonedas_day')
#conectar_db()
